  ...
  return (
    <div className={mode ? ismode : notismode}>
      ...
      <div
        className={
          mode
            ? "flex flex-col sm:flex-row sm:justify-between bg-black sticky top-0"
            : "flex flex-col sm:flex-row sm:justify-between bg-gray-100 sticky top-0"
        }
      >
        <div>
        ...
        <div className="">
          <ul className="flex flex-row justify-between">
            ...
            <li className="hidden sm:flex mx-2">
              <HashLink className="text-decoration-none" smooth to={"#Project"}>
                Project
              </HashLink>
            </li>
            <li className="sm:hidden mx-2">
            ...
            <li className="hidden mx-2 sm:flex">
              <HashLink className="text-decoration-none" smooth to={"#Contact"}>
                Contact
              </HashLink>
            </li>
